...
export async function generateMetadata({ params }: ProjectPageProps) {
  ...
  // Obtener la imagen principal con el nuevo sistema
  const mainImage = project.images?.[0] || project.mainImage || project.image;
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-950 pt-20">
        ...
        {/* 🔥 IMAGEN PRINCIPAL DEL PROYECTO - CON NUEVO SISTEMA CLOUDINARY */}
        {(project.images?.[0] || project.mainImage || project.image) && (
          <section className="pb-16">
            <div className="container mx-auto px-4">
              <div className="max-w-5xl mx-auto">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-800 hover:border-cyan-500/30 transition-colors">
                  <div className="aspect-video relative bg-gray-900">
                    <img
                      src={project.images?.[0] || project.mainImage || project.image}
                      alt={project.title}
              ...
              <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-wrap gap-3">
                  {project.technologies.map((tech: string, index: number) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-gray-800 text-cyan-400 rounded-lg border border-cyan-500/30 font-mono text-sm hover:bg-gray-750 hover:border-cyan-400/50 transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {Object.entries(project.metrics).map(([key, value], index) => (
                    <div key={index} className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-6 text-center hover:border-cyan-500/30 transition-colors">
              ...
              <div className="max-w-5xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {project.features.map((feature: string, index: number) => (
                    <div
                      key={index}
                      className="flex items-start space-x-3 bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg p-4 hover:border-cyan-500/30 transition-colors"
                    >
