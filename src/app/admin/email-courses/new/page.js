// src/app/admin/email-courses/new/page.js
'use client'
import { useState } from 'react'
import { useRouter } from 'next/navigation'
import Link from 'next/link'

export default function NewEmailCoursePage() {
  ...
  return (
    <div className="p-8 max-w-6xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">Configura un curso de email automático de 5 días</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* Emails */}
        <div className="bg-gray-800 rounded-lg p-6">
          <h2 className="text-xl font-bold text-white mb-4">Emails del Curso (5 días)</h2>
