// scripts/migrate-appointments.js - VERSIÓN CORREGIDA
...
if (!MONGODB_URI) {
  ...
  console.log('   set MONGODB_URI=mongodb+srv://... && node scripts/migrate-appointments.js');
  console.log('\n2. Como argumento:');
  console.log('   node scripts/migrate-appointments.js "mongodb+srv://..."');
  process.exit(1);
}
